...
<div class="m-6 pb-0">
    ...
    @foreach ($programmes as $index => $programme)
        <div class="p-6 page-card mb-2 hover:bg-gray-100">
            ...
            <div class="flex">
                <p class="mb-1"><span class="italic font-bold">Year (w.e.f) :</span> {{ $programme->wef->format('Y')}}</p>
                <div class="ml-auto">
                    <a href="{{ route('programme_revision.create', $programme) }}" class="btn btn-magenta is-sm shadow-inset mr-2"> Revise </a>
                    <a href="{{ route('programme_revision.show', $programme) }}" class="btn btn-magenta is-sm shadow-inset mr-2">Show Versions</a>
                </div>            
            </div>
            <div class="mt-3">

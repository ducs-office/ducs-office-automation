<sidebar-nav inline-template>
    <div v-if="is_visible" class="bg-magenta-800 text-white sm:w-80 flex flex-col flex-shrink-0 w-full">
        <div class="h-20 flex items-center px-4 mb-8">
            ...
            <div class="self-center flex-grow text-right">
                <button class="sm:hidden p-3 bg-magenta-800 hover:bg-magenta-900 text-white btn" @click="is_visible = false">

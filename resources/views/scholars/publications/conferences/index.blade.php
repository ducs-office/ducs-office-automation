                ...
                <li class="border-b last:border-b-0 py-3">
                    <div class="flex">
                        ...
                        <div class="ml-auto p-2 flex">
                            <a href="{{ route('scholars.profile.publication.conference.edit', $conference) }}" 
                            ...
                            <form method="POST" action="{{ route('scholars.profile.publication.conference.destroy', $conference->id) }}"

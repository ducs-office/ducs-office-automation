<div x-data="CustomSelect({
    ...
    <div x-show="open" x-on:click.away="open = false"
        ...
        <ul tabindex="-1" x-ref="listbox" class="py-2 max-h-64 overflow-y-auto focus:outline-none">
            ...
            <x-select.option class="px-4 py-2" :index="$index" value="{{ $course->id }}">
                <div class="flex space-x-2">
                    <span class="bg-gray-200 text-gray-900 px-4 py-1 text-sm rounded-full">{{ $course->code }}</span>

<div class="h-20 flex items-center px-4 mb-8">
    ...
    <a href="{{ route('college_teachers.dashboard') }}" class="inline-block logo leading-tight max-w-sm mr-4">
...
<aside class="flex-1 px-4">
    <ul class="font-bold text-white-90">
        <li class="mb-1 last:mb-0">
            <a href="{{ route('college_teachers.dashboard') }}" class="flex items-center py-2 px-4 hover:bg-magenta-700 rounded">

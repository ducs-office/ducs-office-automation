    ...
    <form action="{{ route('staff.colleges.update', $college) }}" method="POST">
        ...
        <div class="flex items-end mb-2">
            <div class="w-32 mr-1">
                ...
                <input id="college_code" type="text" name="code" class="w-full form-input" value="{{ old('code', $college->code) }}">
            </div>
            <div class="flex-1 ml-1">
                <label for="college_name" class="w-full form-label mb-1">College Name<span
                        class="h-current text-red-500 text-lg">*</span></label>
                <input id="college_name" type="text" name="name" class="w-full form-input" value="{{ old('name', $college->name) }}">
            </div>
        </div>
        <div class="mb-2">
            ...
            <input id="college_website" type="text" name="website" class="w-full form-input"
                value="{{ old('website', $college->website ?? 'http://')}}" required>
        </div>
        <div class="mb-2">
        ...
        <div class="mb-2">
            ...
            <input id="college_principal_name" type="text" name="principal_name"
                class="w-full form-input" value="{{ old('principal_name', $college->principal_name) }}" required>
        </div>
        <div class="flex items-end mb-2">
            <div class="flex-1 mr-1">
                ...
                <input id="college_principal_phone1" type="text" name="principal_phones[]" class="w-full form-input"
                    value="{{ old('principal_phones', $college->principal_phones)[0] ?? '' }}" required>
            </div>
            <div class="flex-1 ml-1">
                ...
                <input id="college_principal_phone2" type="text" name="principal_phones[]" class="w-full form-input"
                    value="{{ old('principal_phones', $college->principal_phones)[1] ?? '' }}">
            </div>
        </div>
        <div class="flex items-end mb-2">
            <div class="flex-1 mr-1">
                ...
                <input id="college_principal_email1" type="email" name="principal_emails[]" class="w-full form-input"
                    value="{{ old('principal_emails', $college->principal_emails)[0] ?? '' }}" required>
            </div>
            <div class="flex-1 ml-1">
                ...
                <input id="college_principal_email2" type="email" name="principal_emails[]" class="w-full form-input"
                    value="{{ old('principal_emails', $college->principal_emails)[1] ?? '' }}">
            </div>
        </div>
        <div class="mt-5">

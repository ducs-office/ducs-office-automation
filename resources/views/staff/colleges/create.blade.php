    ...
    <form action="{{ route('staff.colleges.index') }}" method="POST" class="items-end">
        ...
        <div class="flex items-end mb-2">
            <div class="w-32 mr-1">
                ...
                <input id="college_code" type="text" name="code" class="w-full form-input" value="{{ old('code') }}">
            </div>
            <div class="flex-1 ml-1">
                <label for="college_name" class="w-full form-label mb-1">College Name<span
                        class="h-current text-red-500 text-lg">*</span></label>
                <input id="college_name" type="text" name="name" class="w-full form-input" value="{{ old('name') }}">
            </div>
        </div>
        <div class="mb-2">
        ...
        <div class="mb-2">
            <label for="college_address" class="w-full form-label mb-1">Address<span
                    class="h-current text-red-500 text-lg">*</span></label>
            <textarea id="college_address" name="address" rows="3" class="w-full form-input" required>{{ old('address') }}</textarea>
        </div>
        <div class="mb-2">

            ...
            <div>
                ...
                @foreach ($teacher->teachingRecords as $record)
                    <details class="mt-6 bg-gray-200 rounded border" open>
                        <summary class="px-4 font-bold cursor-pointer outline-none py-2"> {{ $record->valid_from->format('M, Y')}} </summary>
                        <div class="px-8">
                            <p>
                                ...
                                in <em class="underline">{{ $record->college->name }}</em> as <strong>{{ $record->getDesignation() }}</strong> teacher.
                            </p>
                        </div>
                    </details>
                @endforeach

<v-modal name="{{ $modalName }}" height="auto">
    <template v-slot="{ data }">
        <div class="p-6">
            <h2 class="text-lg font-bold mb-8">Update PhD Course</h2>
            <form :action="route('staff.phd_courses.update', data('course', ''))" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-2">
                    <label for="course_type" class="w-full form-label">Type<span
                            class="h-current text-red-500 text-lg">*</span></label>
                    <select class="w-full form-select" name="type" required :value="data('course.type')">
